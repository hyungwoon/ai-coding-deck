...
const JOURNEY = [
  { t: "00", label: "셋업", desc: "Claude Desktop + Code 탭", min: "10분" },
  ...
  { t: "05", label: "핸즈온 실습", desc: "내 DESIGN.md 4개", min: "90분" },
];
...
const S = forwardRef<HTMLElement, P>(({ anim, index }, ref) => (
  <SectionShell ref={ref} index={index}>
    ...
    <h2 className={cn("text-3xl font-bold tracking-tight sm:text-5xl mb-4", anim(index))}>
      4시간 뒤, 당신 손에 <span className="text-muted-foreground">DESIGN.md 4개</span>가 남는다
    </h2>
