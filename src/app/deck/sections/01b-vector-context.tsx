    ...
    <div>
      ...
      <div className={cn("grid grid-cols-2 gap-5 mb-5", anim(index))} style={{ transitionDelay: "100ms" }}>
        ...
        <div className="rounded-2xl border border-border/40 bg-card/80 p-6 shadow-sm backdrop-blur-sm">
          ...
          <div className="space-y-2">
            <div className="bg-muted/40 rounded-lg p-3">
              <p className="text-sm font-semibold text-foreground mb-1">의미가 같으면 가깝다</p>
              <p className="text-sm text-muted-foreground">"강아지"와 "개"는 벡터 공간에서 거의 같은 위치</p>
            </div>
            <div className="bg-muted/40 rounded-lg p-3">
              <p className="text-sm font-semibold text-foreground mb-1">벡터 연산이 가능하다</p>
              <p className="text-sm text-muted-foreground">왕 − 남자 + 여자 ≈ 여왕. 의미를 더하고 빼는 수식이 동작</p>
            </div>
            <div className="bg-muted/40 rounded-lg p-3">
              <p className="text-sm font-semibold text-primary mb-1">온톨로지 + 벡터DB (RAG)</p>
              <p className="text-sm text-muted-foreground">지식을 벡터로 저장하면 AI가 의미 기반으로 검색 가능</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-border/40 bg-card/80 p-6 shadow-sm backdrop-blur-sm">
          ...
          <div className="font-mono text-sm bg-muted/30 rounded-xl p-4">
            <p className="text-muted-foreground text-xs uppercase tracking-widest mb-3">컨텍스트 윈도우 (200K tokens)</p>
            <div className="space-y-2">
              {[
            ...
            <p className="text-muted-foreground/50 text-xs mt-3">Claude 200K = A4 약 500장 분량</p>
          </div>
        </div>
      </div>
      ...
      <div className={cn("grid grid-cols-3 gap-4", anim(index))} style={{ transitionDelay: "200ms" }}>
        <div className="rounded-2xl border border-border/40 bg-card/80 p-5 shadow-sm backdrop-blur-sm">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">한 번에 처리할 수 있는 텍스트 한도. Claude 최대 200K 토큰.</p>
        </div>
        <div className="rounded-2xl border border-border/40 bg-card/80 p-5 shadow-sm backdrop-blur-sm">
          <p className="font-mono text-sm text-muted-foreground uppercase tracking-widest mb-2">CONCEPT</p>
          <p className="text-sm font-semibold mb-1.5">시맨틱 서치</p>
          <p className="text-sm text-muted-foreground leading-relaxed">벡터 유사도로 의미가 같은 내용을 찾는다. 키워드가 달라도 정확히 검색.</p>
        </div>
        <div className="rounded-2xl border border-border/40 bg-card/80 p-5 shadow-sm backdrop-blur-sm">
          <p className="font-mono text-sm text-muted-foreground uppercase tracking-widest mb-2">CONCEPT</p>
          <p className="text-sm font-semibold mb-1.5">RAG 패턴</p>
          <p className="text-sm text-muted-foreground leading-relaxed">외부 지식을 벡터 DB에 저장 → 검색 → 컨텍스트에 주입. 최신 정보 활용 가능.</p>
        </div>
      </div>
    </div>
  </SectionShell>
