    ...
    <div>
      ...
      <div className={cn("grid grid-cols-2 gap-5 mb-5", anim(index))} style={{ transitionDelay: "100ms" }}>
        ...
        <div className="rounded-2xl border border-border/40 bg-card/80 p-6 shadow-sm backdrop-blur-sm">
          ...
          <div className="font-mono text-xs bg-muted/30 rounded-xl p-4 space-y-2">
            <p className="text-muted-foreground/60 text-[10px] mb-3">예: "그가 공을 찼다"</p>
            <div className="flex items-center gap-2">
              ...
              <span className="text-primary text-[10px]">강</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-muted-foreground w-8">공을</span>
              <div className="h-px flex-1 bg-primary/30 rounded" />
              <span className="text-foreground font-bold w-10">찼다</span>
              <span className="text-muted-foreground text-[10px]">중</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-foreground font-bold w-8">그</span>
              <div className="h-px flex-1 bg-border/40 rounded border-dashed" />
              <span className="text-muted-foreground w-10">공을</span>
              <span className="text-muted-foreground/40 text-[10px]">약</span>
            </div>
            <p className="text-muted-foreground/40 text-center text-[10px] pt-1">선이 굵을수록 강한 연관 (attention weight)</p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-border/40 bg-card/80 p-6 shadow-sm backdrop-blur-sm">
          ...
          <div className="font-mono text-xs bg-muted/30 rounded-xl p-4">
            <p className="text-muted-foreground/60 text-[10px] mb-3">토큰 생성 루프</p>
      ...
      <div className={cn("grid grid-cols-3 gap-4", anim(index))} style={{ transitionDelay: "200ms" }}>
        <div className="rounded-2xl border border-border/40 bg-card/80 p-5 shadow-sm backdrop-blur-sm">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">한 번에 처리할 수 있는 텍스트 한도. Claude 최대 200K 토큰 — A4 약 500장.</p>
        </div>
        <div className="rounded-2xl border border-border/40 bg-card/80 p-5 shadow-sm backdrop-blur-sm">
          <p className="font-mono text-xs text-muted-foreground uppercase tracking-widest mb-2">CONCEPT</p>
          <p className="text-sm font-semibold mb-1.5">할루시네이션</p>
          <p className="text-xs text-muted-foreground leading-relaxed">모르는 것도 그럴듯하게 지어냄. "패턴 예측" 구조이기 때문. 중요 정보는 검증 필수.</p>
        </div>
        <div className="rounded-2xl border border-border/40 bg-card/80 p-5 shadow-sm backdrop-blur-sm">
          <p className="font-mono text-xs text-muted-foreground uppercase tracking-widest mb-2">CONCEPT</p>
          <p className="text-sm font-semibold mb-1.5">프롬프트 엔지니어링</p>
          <p className="text-xs text-muted-foreground leading-relaxed">어떻게 질문하느냐가 출력 품질을 결정. 역할 부여, 예시, 단계 분해로 결과가 달라진다.</p>
        </div>
      </div>
    </div>
  </SectionShell>
