    ...
    <div className={cn("grid grid-cols-2 gap-5 mb-5", anim(index))} style={{ transitionDelay: "150ms" }}>
      ...
      <div className="rounded-2xl border border-border/40 bg-card/80 shadow-sm backdrop-blur-sm overflow-hidden">
        <div className="bg-muted/30 border-b border-border/40 px-5 py-3">
          <p className="text-[10px] font-mono tracking-widest text-muted-foreground uppercase">Claude Code 요금제</p>
        </div>
          ...
          {plans.map((plan) => (
            <div key={plan.name} className="flex items-center justify-between rounded-xl border border-border/30 bg-muted/20 px-4 py-3">
              ...
              <p className="font-mono text-sm font-semibold text-primary shrink-0 ml-3">
                {plan.price}<span className="text-[10px] font-normal text-muted-foreground">{plan.unit}</span>
              </p>
            </div>
          ))}
        </div>
      ...
      <div className="rounded-2xl border border-border/40 bg-card/80 shadow-sm backdrop-blur-sm overflow-hidden">
        <div className="bg-muted/30 border-b border-border/40 px-5 py-3">
          <p className="text-[10px] font-mono tracking-widest text-muted-foreground uppercase">API 토큰 요금 (Sonnet 4.5 기준)</p>
        </div>
        <div className="p-4">
          <div className="rounded-xl bg-muted/40 px-4 py-4 font-mono text-sm mb-3">
            ...
            <div className="border-t border-border/40 pt-2 flex justify-between">
              <span className="text-muted-foreground text-[11px]">1M 토큰 ≈</span>
              <span className="text-muted-foreground/60 text-[11px]">A4 약 2,500장</span>
            </div>
          </div>
          <div className="rounded-xl border border-border/30 bg-muted/20 px-4 py-3 text-[11px] text-muted-foreground leading-relaxed">
